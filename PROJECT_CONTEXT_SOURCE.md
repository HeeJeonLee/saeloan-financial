...
# 파일 출처: .\SNS_MARKETING_STRATEGY.md (운영 구조 핵심 원칙)

---

## ⚠️ 절대 불변 운영 제약

> **이희전 팀장은 우리은행 소속 대출상담사 팀장 → 대부중개업 겸직 불가**
> **모든 SNS·광고·콘텐츠는 김덕진 대표 명의로만 운영**
> **SNS 계정 실소유자(이희전)는 대외 완전 비공개**

| 항목 | 내용 |
|---|---|
| 홈페이지 소유 | 김덕진 (도메인·사업자 명의) |
| 실제 운영·관리 | 비공개 (대외 노출 절대 금지) |
| SNS 계정 개설 | 이희전 계정이나 대외 명의·얼굴·이름은 김덕진만 |
| 대표전화 | 010-5927-9205 (김덕진 명의 / 이희전 실수신) |
| 공식 전화 (홈페이지) | 1555-2137 |
| 얼굴·목소리 출연 | 김덕진 직접 출연 or 자막+화면 구성만으로 제작 |

**절대 금지:** SNS 어디에도 이희전 이름·직책·소속 노출 / "운영자 따로 있음" 암시 표현

---

# 파일 출처: .\SNS_SALES_SYSTEM.md (SNS 영업 전략 누적 마스터)
...
`
유튜브 숏폼 / 인스타 릴스 → saeloan.co.kr → 카카오톡 상담 → 전화 → 파트너사 연결
`

보조: 텔레그램, 네이버 카페 활동, 블로그 댓글 참여
